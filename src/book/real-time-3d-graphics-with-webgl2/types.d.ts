...
declare namespace utils {
   ...
   */
  export function getGLContext(canvas): WebGL2RenderingContext;
   ...
   * @param {HTMLCanvasElement} canvas
   */
  export function autoResizeCanvas(canvas: HTMLCanvasElement): void;
   ...
   */
  export function getShader(gl, id): WebGLShader | null;
   ...
   */
  export function normalizeColor(color): [number, number, number];
   ...
   * @returns {[number,number,number]}
   */
  export function denormalizeColor(color): [number, number, number];
   ...
   */
  export function calculateNormals(vs, ind): Array<number>;

  /**
   * A simpler API on top of the dat.GUI API, specifically
   * designed for this book for a simpler codebase
   * @param settings
   * @param {{width:number,gui:any}} options
   */
  export function configureControls(settings: any, options?: any): { width: number; gui: any };
...
declare class vec2 extends Float32Array {
   ...
   * @returns a
   */
  public static forEach(a: Float32Array, stride: number, offset: number, count: number, fn: (a: vec2 | number[], b: vec2 | number[]) => void): Float32Array;
...
declare class vec3 extends Float32Array {
   ...
   * @returns out
   */
  public static copy(out: vec3 | number[], a: vec3 | number[]): vec3;
   ...
   * @returns out
   */
  public static negate(out: vec3 | number[], a: vec3 | number[]): vec3;
   ...
   * @function
   */
  public static forEach(a: Float32Array, stride: number, offset: number, count: number, fn: (a: vec3 | number[], b: vec3 | number[]) => void): Float32Array;
...
declare class vec4 extends Float32Array {
   ...
   * @function
   */
  public static forEach(a: Float32Array, stride: number, offset: number, count: number, fn: (a: vec4 | number[], b: vec4 | number[]) => void): Float32Array;
...
declare class mat4 extends Float32Array {
   ...
   * @returns out
   */
  public static frustum(out: mat4, left: number, right: number, bottom: number, top: number, near: number, far: number): mat4;
   ...
   * @returns out
   */
  public static ortho(out: mat4, left: number, right: number, bottom: number, top: number, near: number, far: number): mat4;
